    ...
    <div className={styles.container}>
      ...
      <Nav></Nav>
        ...
        <p className={styles.body}>
          ...
          <br />
          These bytes help tell the computer how to interpret and serve these files to the user, and are commonly
          shown to us in the form of file extensions. 
          <br />
          In this challenge,
          the flag is part of the file, but the file itself has had its extension removed. 
          <br />
          See if you can find the flag.
        </p>
        <code className={styles.code}>Download the file <a href="/chal/3" className={styles.download} download="3">here.</a></code>
